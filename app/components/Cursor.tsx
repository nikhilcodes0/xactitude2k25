  ...
  return (
    <div
      ...
      className={clsx(
        ...
        hoverType === 'card' && 'w-fit h-11 cursor-none pt-3 bg-[#40E0D0] rounded-lg', // Scale for card hover
    ...
    >
      ...
      {hoverType === 'card' && (
        <span className="text-black text-sm font-semibold py-3  px-3 border-2 border-black rounded-lg font-sans text-center">
          Learn More
        </span>
      )}
    </div>

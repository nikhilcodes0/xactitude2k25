      ...
      <div className="bg-[0d0d0d] mt-32">
        ...
        <div className="z-10 ">
          <div className="mt-[22rem] z-10">
            <div className=" mt-[18rem] ">
              ...
              <div
                className={`${meraPro.className} relative bottom-[4rem] md:hidden `}
              >
                <VelocityScroll
        ...
        <div className="mt-[30rem] md:mt-[30rem] lg:mt-[40rem] lg:pl-8">
          <h1 className="text-white  text-[3rem]  font-black font-sans text-start p-4 px-3 md:flex md:text-[3rem] lg:text-[4rem] xl:text-[5rem]  ">
            Welcome to
            <p className="bg-gradient-to-b bg-clip-text text-transparent from-neutral-200 to-[#40E0D0]  text-[3.5rem] md:text-[3rem] lg:text-[4rem] xl:text-[5rem]   md:ml-4 font-black">
              XACTITUDE&#39;25
            </p>
          </h1>
        </div>
